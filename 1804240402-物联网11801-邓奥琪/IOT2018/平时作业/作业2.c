...
void CreateBST(BiTree &T, int a[], int n);//创建
int SearchBST(BiTree T,KeyType key,BiTree f,BiTree *p);//查找
int InsertBST(BiTree &T,ElemType e);//插入
int Delete(BiTree &p);//删除子函数
...
{
    int i;
    int a[15]={19,38,12,40,41,39,54,76,35,47,80,14,9,44,60};
    BiTree T = NULL;
    for (i = 0;i < 15;i++) {
        InsertBST(T, a[i]);
    }
